...
> = {
  ...
  orange: {
    outer: "bg-gradient-to-b from-[#3b0b00] to-[#ff8a2a]",
    inner: "bg-gradient-to-b from-[#ffe1c8] via-[#ff4500] to-[#7a1700]",
    button: "bg-gradient-to-b from-[#ff8a2a] via-[#ff4500] to-[#b92700]",
    textColor: "text-white",
    textShadow: "[text-shadow:_0_-1px_0_rgb(90_18_0_/_100%)]",
  },
};
    ...
    wrapperStyle: {
      ...
      boxShadow: isPressed
        ...
        : isHovered && !isTouchDevice
          ? "0 10px 32px rgba(255, 69, 0, 0.28)"
...
const MetalButton = React.forwardRef<HTMLButtonElement, MetalButtonProps>(
  ({ children, className, variant = "orange", ...props }, ref) => {
